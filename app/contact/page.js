  ...
  return (
    <div className="w-full min-h-screen flexs">
      ...
      <section className="flex flex-col my-12">
        <h1 className="text-center text-red-700 font-bold text-5xl font-serif">Contact With Us</h1>
        <p className="mt-10 ml-90 text-md md:w-1/2 overflow-hidden tracking-widest">
